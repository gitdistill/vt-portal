            ...
            <header class="content-header">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-extend pull-right" role="menu">
                            ...
                            <li class="dropdown-footer">
                                <div class="clearfix">
                                    <a href="page_signin.php" class="btn btn-sm btn-default pull-right">Sign out</a>
                                    <a href="profile.php" class="btn btn-sm btn-default pull-left">Profile</a>
                                </div>
                            </li><!-- /dropdown-footer -->
                        </ul><!-- /dropdown-extend -->
                ...
                <h1 class="content-title">Client Portal</h1>
            </header><!-- /side left --