                    ...
                    <div class="content-app fixed-header">
                        ...
                        <div class="app-body">
							...
							<div class="magic-layout">                              
                                <div id="feedback" class="box magic-element width-full">
                                    <h2 class="box-heading">
                                       <strong>Feedback & Feature Requests</strong>
                                    </h2>
                                    <p>Please give us feedback on how the ticketing portal is working by entering a brief description of what you would change or add to make the portal more useful for you.</p>
                                    <hr>
                                    <div class="row">
                                    	<div class="col-sm-10">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="input" placeholder="email address" >
                                                </div>
                                            </div><!-- /form-group -->
                                            <div class="form-group">
